...
def parse():
    ...
    parser.add_argument('--dataset_name', default = 'FB15K237_sampled', type = str, \
                        choices = ['FB15K237_sampled', 'CoDEx-M_sampled', 'UMLS-43'])
    ...
    parser.add_argument('-s', '--norm', default = 20.0, type = float)
