...
class ReED(nn.Module):
    def __init__(self, hid_ent, hid_rel, dim_final, num_RAMPLayer, num_ent, num_rel, dim_in_ent, dim_in_rel,\
        ...
        layers = []
        projs_rel = []
        dim_in_ent = dim_in_ent
        dim_in_rel = dim_in_rel
    ...
    def forward(self, triplets, emb_ent, emb_rel):
